...
```bash
claude plugin marketplace add Code-My-Spec/code_my_spec_claude_code_extension
claude plugin install codemyspec@codemyspec
```

Then download the CLI binary:

```bash
bash ~/.claude/plugins/cache/codemyspec/install.sh
```
